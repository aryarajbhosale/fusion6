...
import { BarChart3, Users, ShoppingBag, DollarSign, Plus, Edit2, Trash2, Search } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          ...
          <p className="text-gray-600 dark:text-gray-300">
            Manage your restaurant operations and view analytics
          </p>
        </motion.div>
          ...
          <div className="border-b border-gray-200 dark:border-gray-700">
            <nav className="-mb-px flex space-x-8">
              {[
                ...
                { id: 'menu', name: 'Menu Management', icon: ShoppingBag },
                { id: 'users', name: 'Users', icon: Users },
                { id: 'insights', name: 'Insights', icon: DollarSign }
              ].map(tab => (
                <button
                  key={tab.id}
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                { title: 'Average Order', value: `$${stats.averageOrder.toFixed(2)}`, icon: BarChart3, color: 'bg-orange-500' }
              ].map((stat, index) => (
                <motion.div
                  key={stat.title}
                  initial={{ opacity: 0, y: 20 }}
          ...
          <div className="space-y-6">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 dark:bg-gray-800 dark:text-white"
              />
            </div>
        ...
        {activeTab === 'users' && (
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 dark:text-gray-400">User management functionality would be implemented here</p>
            </div>
          </div>
        )}
        ...
        {activeTab === 'insights' && (
          <div className="space-y-8">
            <h2 className="text-2xl font-bold text-gray-800 dark:text-white">Business Insights</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  {menuItems.slice(0, 5).map((item, index) => (
                    <div key={item.id} className="flex items-center justify-between">
                      ...
                      <span className="text-sm font-medium text-gray-800 dark:text-white">
                        {Math.floor(Math.random() * 100) + 20} orders
                      </span>
                    </div>
                  ))}
                </div>
              ...
              >
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-gray-600 dark:text-gray-300">This Quarter</span>
              ...
              >
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm font-medium text-gray-800 dark:text-white">4.6/5</span>
                  </div>
                  <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-gray-600 dark:text-gray-300">5-Star Reviews</span>
